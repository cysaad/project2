...
def main():
    ...
    with st.form("prediction_form"):
        ...
        instructions = {
            ...
            "restecg": "Resting electrocardiographic results(0=NL,1=T inversion,2=LVH).",
            "thalach": "Maximum heart rate achieved.",
            "exang": "Exercise-induced angina (1 = yes; 0 = no).",
            "oldpeak": "ST depression induced by exercise relative to rest(0=negative,1=positive).",
            "slope": "The slope of the peak exercise ST segment(1=upsloping,2=flar,3=downslopinh).",
